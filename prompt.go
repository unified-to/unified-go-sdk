...
func newPrompt(sdkConfig sdkConfiguration) *Prompt {
	return &Prompt{
...
func (s *Prompt) CreateGenaiPrompt(ctx context.Context, request operations.CreateGenaiPromptRequest) (*operations.CreateGenaiPromptResponse, error) {
