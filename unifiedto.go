...
// Generated from OpenAPI doc version 1.0 and generator version 2.624.0
...
func New(opts ...SDKOption) *UnifiedTo {
	sdk := &UnifiedTo{
		SDKVersion: "0.26.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.26.0 2.624.0 1.0 github.com/unified-to/unified-go-sdk",
