...
// Generated from OpenAPI doc version 1.0 and generator version 2.632.2
...
func New(opts ...SDKOption) *UnifiedTo {
	sdk := &UnifiedTo{
		SDKVersion: "0.27.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.27.0 2.632.2 1.0 github.com/unified-to/unified-go-sdk",
