...
// Generated from OpenAPI doc version 1.0 and generator version 2.916.4
...
func New(opts ...SDKOption) *UnifiedTo {
	sdk := &UnifiedTo{
		SDKVersion: "0.36.88",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.36.88 2.916.4 1.0 github.com/unified-to/unified-go-sdk",
