...
// Generated from OpenAPI doc version 1.0 and generator version 2.933.0
...
func New(opts ...SDKOption) *UnifiedTo {
	sdk := &UnifiedTo{
		SDKVersion: "0.36.121",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.36.121 2.933.0 1.0 github.com/unified-to/unified-go-sdk",
	...
	sdk.Bankfeedaccount = newBankfeedaccount(sdk, sdk.sdkConfiguration, sdk.hooks)
	sdk.Bankfeedtransaction = newBankfeedtransaction(sdk, sdk.sdkConfiguration, sdk.hooks)
