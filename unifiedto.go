...
// Generated from OpenAPI doc version 1.0 and generator version 2.846.4
...
func New(opts ...SDKOption) *UnifiedTo {
	sdk := &UnifiedTo{
		SDKVersion: "0.36.40",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.36.40 2.846.4 1.0 github.com/unified-to/unified-go-sdk",
