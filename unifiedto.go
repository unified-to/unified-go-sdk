...
// Generated from OpenAPI doc version 1.0 and generator version 2.918.3
...
func New(opts ...SDKOption) *UnifiedTo {
	sdk := &UnifiedTo{
		SDKVersion: "0.36.92",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.36.92 2.918.3 1.0 github.com/unified-to/unified-go-sdk",
