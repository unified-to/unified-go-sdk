...
func (s *enrich) GetEnrichConnectionIDCompany(ctx context.Context, request operations.GetEnrichConnectionIDCompanyRequest, security operations.GetEnrichConnectionIDCompanySecurity) (*operations.GetEnrichConnectionIDCompanyResponse, error) {
...
func (s *enrich) GetEnrichConnectionIDPerson(ctx context.Context, request operations.GetEnrichConnectionIDPersonRequest, security operations.GetEnrichConnectionIDPersonSecurity) (*operations.GetEnrichConnectionIDPersonResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
