...
func (s *Channel) GetMessagingChannel(ctx context.Context, request operations.GetMessagingChannelRequest) (*operations.GetMessagingChannelResponse, error) {
...
func (s *Channel) ListMessagingChannels(ctx context.Context, request operations.ListMessagingChannelsRequest) (*operations.ListMessagingChannelsResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
