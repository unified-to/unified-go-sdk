...
func (s *Integration) ListUnifiedIntegrations(ctx context.Context, request operations.ListUnifiedIntegrationsRequest, security operations.ListUnifiedIntegrationsSecurity) (*operations.ListUnifiedIntegrationsResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
