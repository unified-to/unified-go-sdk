...
func newTracking(rootSDK *UnifiedTo, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Tracking {
	return &Tracking{
		rootSDK:          rootSDK,
...
func (s *Tracking) CreateShippingTracking(ctx context.Context, request operations.CreateShippingTrackingRequest, opts ...operations.Option) (*operations.CreateShippingTrackingResponse, error) {
