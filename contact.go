...
func (s *contact) DeleteCrmConnectionIDContactIDCompanyCompanyID(ctx context.Context, request operations.DeleteCrmConnectionIDContactIDCompanyCompanyIDRequest) (*operations.DeleteCrmConnectionIDContactIDCompanyCompanyIDResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
...
func (s *contact) DeleteCrmConnectionIDContactIDDealDealID(ctx context.Context, request operations.DeleteCrmConnectionIDContactIDDealDealIDRequest) (*operations.DeleteCrmConnectionIDContactIDDealDealIDResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
...
func (s *contact) PatchCrmConnectionIDContactIDCompanyCompanyID(ctx context.Context, request operations.PatchCrmConnectionIDContactIDCompanyCompanyIDRequest) (*operations.PatchCrmConnectionIDContactIDCompanyCompanyIDResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	url, err := utils.GenerateURL(ctx, baseURL, "/crm/{connection_id}/contact/{id}/company/{company_id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
...
func (s *contact) PatchCrmConnectionIDContactIDDealDealID(ctx context.Context, request operations.PatchCrmConnectionIDContactIDDealDealIDRequest) (*operations.PatchCrmConnectionIDContactIDDealDealIDResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	url, err := utils.GenerateURL(ctx, baseURL, "/crm/{connection_id}/contact/{id}/deal/{deal_id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
...
func (s *contact) PutCrmConnectionIDContactIDCompanyCompanyID(ctx context.Context, request operations.PutCrmConnectionIDContactIDCompanyCompanyIDRequest) (*operations.PutCrmConnectionIDContactIDCompanyCompanyIDResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	url, err := utils.GenerateURL(ctx, baseURL, "/crm/{connection_id}/contact/{id}/company/{company_id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
...
func (s *contact) PutCrmConnectionIDContactIDDealDealID(ctx context.Context, request operations.PutCrmConnectionIDContactIDDealDealIDRequest) (*operations.PutCrmConnectionIDContactIDDealDealIDResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	url, err := utils.GenerateURL(ctx, baseURL, "/crm/{connection_id}/contact/{id}/deal/{deal_id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
