...
func (s *Call) ListUcCalls(ctx context.Context, request operations.ListUcCallsRequest, security operations.ListUcCallsSecurity) (*operations.ListUcCallsResponse, error) {
