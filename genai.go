...
func newGenai(sdkConfig sdkConfiguration) *Genai {
	return &Genai{
...
func (s *Genai) CreateGenaiPrompt(ctx context.Context, request operations.CreateGenaiPromptRequest) (*operations.CreateGenaiPromptResponse, error) {
...
func (s *Genai) ListGenaiModels(ctx context.Context, request operations.ListGenaiModelsRequest) (*operations.ListGenaiModelsResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
