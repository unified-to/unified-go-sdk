...
func newUnified(rootSDK *UnifiedTo, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Unified {
	return &Unified{
		rootSDK:          rootSDK,
...
func (s *Unified) CreateUnifiedEnvironment(ctx context.Context, request []string, opts ...operations.Option) (*operations.CreateUnifiedEnvironmentResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/unified/environment")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.CreateUnifiedEnvironmentResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
// CreateUnifiedWorkspaceSecretsmanager - Create secrets manager
func (s *Unified) CreateUnifiedWorkspaceSecretsmanager(ctx context.Context, request shared.SecretsManager, opts ...operations.Option) (*operations.CreateUnifiedWorkspaceSecretsmanagerResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := url.JoinPath(baseURL, "/unified/workspace/secretsmanager")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "createUnifiedWorkspaceSecretsmanager",
		SecuritySource:   s.sdkConfiguration.Security,
	}
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "Request", "json", `request:"mediaType=application/json"`)
	if err != nil {
	...
	res := &operations.CreateUnifiedWorkspaceSecretsmanagerResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out shared.SecretsManager
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.SecretsManager = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Unified) GetUnifiedIssue(ctx context.Context, request operations.GetUnifiedIssueRequest, opts ...operations.Option) (*operations.GetUnifiedIssueResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/unified/issue/{id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.GetUnifiedIssueResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
// GetUnifiedWorkspaceSecretsmanager - Retrieve secrets manager
func (s *Unified) GetUnifiedWorkspaceSecretsmanager(ctx context.Context, request operations.GetUnifiedWorkspaceSecretsmanagerRequest, opts ...operations.Option) (*operations.GetUnifiedWorkspaceSecretsmanagerResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/unified/workspace/secretsmanager/{id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "getUnifiedWorkspaceSecretsmanager",
		SecuritySource:   s.sdkConfiguration.Security,
	}
	...
	res := &operations.GetUnifiedWorkspaceSecretsmanagerResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
func (s *Unified) ListUnifiedEnvironments(ctx context.Context, opts ...operations.Option) (*operations.ListUnifiedEnvironmentsResponse, error) {
	...
	res := &operations.ListUnifiedEnvironmentsResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
// ListUnifiedNotifications - List event notifications
func (s *Unified) ListUnifiedNotifications(ctx context.Context, request operations.ListUnifiedNotificationsRequest, opts ...operations.Option) (*operations.ListUnifiedNotificationsResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := url.JoinPath(baseURL, "/unified/notification")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.ListUnifiedNotificationsResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
// ListUnifiedWorkspaceSecretsmanagers - List secrets managers
func (s *Unified) ListUnifiedWorkspaceSecretsmanagers(ctx context.Context, request operations.ListUnifiedWorkspaceSecretsmanagersRequest, opts ...operations.Option) (*operations.ListUnifiedWorkspaceSecretsmanagersResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "listUnifiedWorkspaceSecretsmanagers",
		SecuritySource:   s.sdkConfiguration.Security,
	}
	...
	res := &operations.ListUnifiedWorkspaceSecretsmanagersResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
func (s *Unified) RemoveUnifiedEnvironment(ctx context.Context, request operations.RemoveUnifiedEnvironmentRequest, opts ...operations.Option) (*operations.RemoveUnifiedEnvironmentResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/unified/environment/{env}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.RemoveUnifiedEnvironmentResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
// RemoveUnifiedWorkspaceSecretsmanager - Remove secrets manager
func (s *Unified) RemoveUnifiedWorkspaceSecretsmanager(ctx context.Context, request operations.RemoveUnifiedWorkspaceSecretsmanagerRequest, opts ...operations.Option) (*operations.RemoveUnifiedWorkspaceSecretsmanagerResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "removeUnifiedWorkspaceSecretsmanager",
		SecuritySource:   s.sdkConfiguration.Security,
	}
	...
	res := &operations.RemoveUnifiedWorkspaceSecretsmanagerResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
