...
func newPayslip(sdkConfig sdkConfiguration) *Payslip {
	return &Payslip{
...
func (s *Payslip) GetHrisPayslip(ctx context.Context, request operations.GetHrisPayslipRequest) (*operations.GetHrisPayslipResponse, error) {
