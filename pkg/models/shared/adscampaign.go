...
const (
	...
	AdsCampaignStatusProcessing           AdsCampaignStatus = "PROCESSING"
	AdsCampaignStatusProcessingFailed     AdsCampaignStatus = "PROCESSING_FAILED"
)
...
type AdsCampaign struct {
	...
	Kpi                      *PropertyAdsCampaignKpi          `json:"kpi,omitempty"`
...
func (a *AdsCampaign) GetCategory() *string {
	if a == nil {
		return nil
	}
	return a.Category
...
func (a *AdsCampaign) GetKpi() *PropertyAdsCampaignKpi {
	if a == nil {
		return nil
	}
	return a.Kpi
