...
const (
	...
	AccountingCreditmemoStatusSubmitted         AccountingCreditmemoStatus = "SUBMITTED"
	AccountingCreditmemoStatusDeleted           AccountingCreditmemoStatus = "DELETED"
...
func (a *AccountingCreditmemo) GetInvoiceID() *string {
	if a == nil {
		return nil
	}
	return a.InvoiceID
...
func (a *AccountingCreditmemo) GetOrganizationID() *string {
	if a == nil {
		return nil
	}
