...
func (a *AccountingBill) GetExtendedNotes() []AccountingExtendedNote {
	if a == nil {
		return nil
	}
...
func (a *AccountingBill) GetOrganizationID() *string {
	if a == nil {
		return nil
	}
...
func (a *AccountingBill) GetPaymenttermID() *string {
	if a == nil {
		return nil
	}
