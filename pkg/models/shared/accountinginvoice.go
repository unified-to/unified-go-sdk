...
type AccountingInvoice struct {
	...
	ExtendedNotes           []AccountingExtendedNote                  `json:"extended_notes,omitempty"`
...
func (a *AccountingInvoice) GetExtendedNotes() []AccountingExtendedNote {
	if a == nil {
		return nil
	}
	return a.ExtendedNotes
}
