...
type CrmMetadata5 struct {
	CrmMetadata1 *CrmMetadata1 `queryParam:"inline" union:"member"`
...
type CrmMetadataExtraData struct {
	...
	Number              *float64       `queryParam:"inline" union:"member"`
	Boolean             *bool          `queryParam:"inline" union:"member"`
	ArrayOfCrmMetadata5 []CrmMetadata5 `queryParam:"inline" union:"member"`
...
type CrmMetadataSchemas5 struct {
	CrmMetadataSchemas1 *CrmMetadataSchemas1 `queryParam:"inline" union:"member"`
	Str                 *string              `queryParam:"inline" union:"member"`
	Number              *float64             `queryParam:"inline" union:"member"`
	Boolean             *bool                `queryParam:"inline" union:"member"`
...
type CrmMetadataValue struct {
	...
	Number                     *float64              `queryParam:"inline" union:"member"`
	Boolean                    *bool                 `queryParam:"inline" union:"member"`
	ArrayOfCrmMetadataSchemas5 []CrmMetadataSchemas5 `queryParam:"inline" union:"member"`
