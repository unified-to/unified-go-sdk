...
func (l ListCalendarCalendarsRequest) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(l, "", false)
}

func (l *ListCalendarCalendarsRequest) UnmarshalJSON(data []byte) error {
...
func (o *ListCalendarCalendarsRequest) GetUpdatedGte() *time.Time {
	if o == nil {
		return nil
	}
	return o.UpdatedGte
