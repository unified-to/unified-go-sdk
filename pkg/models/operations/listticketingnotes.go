...
type ListTicketingNotesSecurity struct {
	Jwt string `security:"scheme,type=apiKey,subtype=header,name=authorization"`
}

func (o *ListTicketingNotesSecurity) GetJwt() string {
	if o == nil {
		return ""
	}
	return o.Jwt
...
func (o *ListTicketingNotesRequest) GetOrder() *string {
	if o == nil {
		return nil
	}
	return o.Order
...
func (o *ListTicketingNotesRequest) GetSort() *string {
	if o == nil {
		return nil
	}
	return o.Sort
