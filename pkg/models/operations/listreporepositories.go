...
func (l ListRepoRepositoriesRequest) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(l, "", false)
}

func (l *ListRepoRepositoriesRequest) UnmarshalJSON(data []byte) error {
...
func (o *ListRepoRepositoriesRequest) GetUpdatedGte() *time.Time {
	if o == nil {
		return nil
	}
	return o.UpdatedGte
