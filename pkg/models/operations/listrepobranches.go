...
func (l ListRepoBranchesRequest) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(l, "", false)
}

func (l *ListRepoBranchesRequest) UnmarshalJSON(data []byte) error {
...
func (o *ListRepoBranchesRequest) GetUpdatedGte() *time.Time {
	if o == nil {
		return nil
	}
	return o.UpdatedGte
