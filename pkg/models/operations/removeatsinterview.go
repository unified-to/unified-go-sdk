...
type RemoveAtsInterviewResponse struct {
	...
	// Successful
	RemoveAtsInterviewDefaultApplicationJSONString *string
}
...
func (o *RemoveAtsInterviewResponse) GetRemoveAtsInterviewDefaultApplicationJSONString() *string {
	if o == nil {
		return nil
	}
	return o.RemoveAtsInterviewDefaultApplicationJSONString
}
