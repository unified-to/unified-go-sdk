...
type ListMartechListsSecurity struct {
	Jwt string `security:"scheme,type=apiKey,subtype=header,name=authorization"`
}

func (o *ListMartechListsSecurity) GetJwt() string {
	if o == nil {
		return ""
	}
	return o.Jwt
...
func (l ListMartechListsRequest) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(l, "", false)
}

func (l *ListMartechListsRequest) UnmarshalJSON(data []byte) error {
...
func (o *ListMartechListsRequest) GetUpdatedGte() *time.Time {
	if o == nil {
		return nil
	}
	return o.UpdatedGte
