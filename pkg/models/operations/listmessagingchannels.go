...
func (l ListMessagingChannelsRequest) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(l, "", false)
}

func (l *ListMessagingChannelsRequest) UnmarshalJSON(data []byte) error {
...
func (o *ListMessagingChannelsRequest) GetUpdatedGte() *time.Time {
	if o == nil {
		return nil
	}
	return o.UpdatedGte
