...
type ListAccountingPaymentsSecurity struct {
	Jwt string `security:"scheme,type=apiKey,subtype=header,name=authorization"`
}

func (o *ListAccountingPaymentsSecurity) GetJwt() string {
	if o == nil {
		return ""
	}
	return o.Jwt
...
func (o *ListAccountingPaymentsRequest) GetConnectionID() string {
	if o == nil {
		return ""
	}
...
func (o *ListAccountingPaymentsRequest) GetInvoiceID() *string {
	if o == nil {
		return nil
	}
	return o.InvoiceID
...
func (o *ListAccountingPaymentsRequest) GetLimit() *float64 {
	if o == nil {
		return nil
	}
	return o.Limit
...
func (o *ListAccountingPaymentsRequest) GetOffset() *float64 {
	if o == nil {
		return nil
	}
	return o.Offset
...
func (o *ListAccountingPaymentsRequest) GetOrder() *string {
	if o == nil {
		return nil
	}
	return o.Order
...
func (o *ListAccountingPaymentsRequest) GetSort() *string {
	if o == nil {
		return nil
	}
	return o.Sort
...
func (o *ListAccountingPaymentsRequest) GetUpdatedGte() *time.Time {
	if o == nil {
		return nil
	}
	return o.UpdatedGte
...
func (o *ListAccountingPaymentsResponse) GetAccountingPayments() []shared.AccountingPayment {
	if o == nil {
		return nil
	}
