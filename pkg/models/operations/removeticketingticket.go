...
func (o *RemoveTicketingTicketResponse) GetRemoveTicketingTicketDefaultApplicationJSONString() *string {
	if o == nil {
		return nil
	}
	return o.RemoveTicketingTicketDefaultApplicationJSONString
}
