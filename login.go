...
func (s *Login) GetUnifiedIntegrationSaml(ctx context.Context, request operations.GetUnifiedIntegrationSamlRequest, opts ...operations.Option) (*operations.GetUnifiedIntegrationSamlResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
