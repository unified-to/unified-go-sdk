...
func newRate(rootSDK *UnifiedTo, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Rate {
	return &Rate{
		rootSDK:          rootSDK,
...
func (s *Rate) GetShippingRate(ctx context.Context, request operations.GetShippingRateRequest, opts ...operations.Option) (*operations.GetShippingRateResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
