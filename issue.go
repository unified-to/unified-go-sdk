...
func (s *Issue) ListUnifiedIssues(ctx context.Context, request operations.ListUnifiedIssuesRequest, security operations.ListUnifiedIssuesSecurity) (*operations.ListUnifiedIssuesResponse, error) {
