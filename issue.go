...
func newIssue(rootSDK *UnifiedTo, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Issue {
	return &Issue{
		rootSDK:          rootSDK,
...
func (s *Issue) GetUnifiedIssue(ctx context.Context, request operations.GetUnifiedIssueRequest, opts ...operations.Option) (*operations.GetUnifiedIssueResponse, error) {
