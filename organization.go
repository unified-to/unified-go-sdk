...
func (s *Organization) GetAccountingOrganization(ctx context.Context, request operations.GetAccountingOrganizationRequest, security operations.GetAccountingOrganizationSecurity) (*operations.GetAccountingOrganizationResponse, error) {
...
func (s *Organization) ListAccountingOrganizations(ctx context.Context, request operations.ListAccountingOrganizationsRequest, security operations.ListAccountingOrganizationsSecurity) (*operations.ListAccountingOrganizationsResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
