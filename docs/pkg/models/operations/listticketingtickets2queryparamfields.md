...
value := operations.ListTicketingTickets2QueryParamFieldsID
```
...
| Name                                               | Value                                              |
| -------------------------------------------------- | -------------------------------------------------- |
| `ListTicketingTickets2QueryParamFieldsID`          | id                                                 |
| `ListTicketingTickets2QueryParamFieldsCreatedAt`   | created_at                                         |
| `ListTicketingTickets2QueryParamFieldsUpdatedAt`   | updated_at                                         |
| `ListTicketingTickets2QueryParamFieldsCustomerID`  | customer_id                                        |
| `ListTicketingTickets2QueryParamFieldsSubject`     | subject                                            |
| `ListTicketingTickets2QueryParamFieldsDescription` | description                                        |
| `ListTicketingTickets2QueryParamFieldsStatus`      | status                                             |
