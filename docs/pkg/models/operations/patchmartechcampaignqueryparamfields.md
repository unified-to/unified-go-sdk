...
value := operations.PatchMartechCampaignQueryParamFieldsID
```
...
| `PatchMartechCampaignQueryParamFieldsListIds`      | list_ids                                           |
| `PatchMartechCampaignQueryParamFieldsSubjectLine`  | subject_line                                       |
| `PatchMartechCampaignQueryParamFieldsPreviewText`  | preview_text                                       |
| `PatchMartechCampaignQueryParamFieldsFromName`     | from_name                                          |
