...
value := operations.UpdateMartechCampaignQueryParamFieldsID
```
...
| `UpdateMartechCampaignQueryParamFieldsListIds`      | list_ids                                            |
| `UpdateMartechCampaignQueryParamFieldsSubjectLine`  | subject_line                                        |
| `UpdateMartechCampaignQueryParamFieldsPreviewText`  | preview_text                                        |
| `UpdateMartechCampaignQueryParamFieldsFromName`     | from_name                                           |
