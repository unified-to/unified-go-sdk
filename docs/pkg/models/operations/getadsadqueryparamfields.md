...
value := operations.GetAdsAdQueryParamFieldsID
```
...
| Name                                       | Value                                      |
| ------------------------------------------ | ------------------------------------------ |
| `GetAdsAdQueryParamFieldsID`               | id                                         |
| `GetAdsAdQueryParamFieldsCreatedAt`        | created_at                                 |
| `GetAdsAdQueryParamFieldsUpdatedAt`        | updated_at                                 |
