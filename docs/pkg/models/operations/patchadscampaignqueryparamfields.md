...
value := operations.PatchAdsCampaignQueryParamFieldsID
```
...
| Name                                                       | Value                                                      |
| ---------------------------------------------------------- | ---------------------------------------------------------- |
| `PatchAdsCampaignQueryParamFieldsID`                       | id                                                         |
| `PatchAdsCampaignQueryParamFieldsCreatedAt`                | created_at                                                 |
| `PatchAdsCampaignQueryParamFieldsUpdatedAt`                | updated_at                                                 |
...
| `PatchAdsCampaignQueryParamFieldsHasEuPoliticalAds`        | has_eu_political_ads                                       |
| `PatchAdsCampaignQueryParamFieldsLabels`                   | labels                                                     |
| `PatchAdsCampaignQueryParamFieldsKpi`                      | kpi                                                        |
