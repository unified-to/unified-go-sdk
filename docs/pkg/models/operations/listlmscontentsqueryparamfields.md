# ListLmsContentsQueryParamFields
...
value := operations.ListLmsContentsQueryParamFieldsID
```
...
| Name                                               | Value                                              |
| -------------------------------------------------- | -------------------------------------------------- |
| `ListLmsContentsQueryParamFieldsID`                | id                                                 |
| `ListLmsContentsQueryParamFieldsCreatedAt`         | created_at                                         |
| `ListLmsContentsQueryParamFieldsUpdatedAt`         | updated_at                                         |
| `ListLmsContentsQueryParamFieldsExternalReference` | external_reference                                 |
| `ListLmsContentsQueryParamFieldsCourseIds`         | course_ids                                         |
| `ListLmsContentsQueryParamFieldsName`              | name                                               |
| `ListLmsContentsQueryParamFieldsDescription`       | description                                        |
| `ListLmsContentsQueryParamFieldsLanguages`         | languages                                          |
| `ListLmsContentsQueryParamFieldsMedia`             | media                                              |
...
| `ListLmsContentsQueryParamFieldsInstructors`       | instructors                                        |
| `ListLmsContentsQueryParamFieldsPublishedAt`       | published_at                                       |
| `ListLmsContentsQueryParamFieldsRaw`               | raw                                                |