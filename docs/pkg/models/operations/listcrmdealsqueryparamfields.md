...
value := operations.ListCrmDealsQueryParamFieldsID
```
...
| Name                                      | Value                                     |
| ----------------------------------------- | ----------------------------------------- |
| `ListCrmDealsQueryParamFieldsID`          | id                                        |
| `ListCrmDealsQueryParamFieldsCreatedAt`   | created_at                                |
| `ListCrmDealsQueryParamFieldsUpdatedAt`   | updated_at                                |
| `ListCrmDealsQueryParamFieldsName`        | name                                      |
| `ListCrmDealsQueryParamFieldsAmount`      | amount                                    |
...
| `ListCrmDealsQueryParamFieldsProbability` | probability                               |
| `ListCrmDealsQueryParamFieldsTags`        | tags                                      |
| `ListCrmDealsQueryParamFieldsLostReason`  | lost_reason                               |
| `ListCrmDealsQueryParamFieldsWonReason`   | won_reason                                |
| `ListCrmDealsQueryParamFieldsUserID`      | user_id                                   |
