...
value := operations.PatchAdsAdQueryParamFieldsID
```
...
| Name                                         | Value                                        |
| -------------------------------------------- | -------------------------------------------- |
| `PatchAdsAdQueryParamFieldsID`               | id                                           |
| `PatchAdsAdQueryParamFieldsCreatedAt`        | created_at                                   |
| `PatchAdsAdQueryParamFieldsUpdatedAt`        | updated_at                                   |
...
| `PatchAdsAdQueryParamFieldsDescription`      | description                                  |
