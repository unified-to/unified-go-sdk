...
value := operations.CreateAdsAdQueryParamFieldsID
```
...
| Name                                          | Value                                         |
| --------------------------------------------- | --------------------------------------------- |
| `CreateAdsAdQueryParamFieldsID`               | id                                            |
| `CreateAdsAdQueryParamFieldsCreatedAt`        | created_at                                    |
| `CreateAdsAdQueryParamFieldsUpdatedAt`        | updated_at                                    |
...
| `CreateAdsAdQueryParamFieldsAdvertiserName`   | advertiser_name                               |
...
| `CreateAdsAdQueryParamFieldsDescription`      | description                                   |
...
| `CreateAdsAdQueryParamFieldsLogoCreativeID`   | logo_creative_id                              |
