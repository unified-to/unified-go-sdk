...
value := shared.PropertyConnectionPermissionsAccountingAccountRead

// Open enum: custom values can be created with a direct type cast
custom := shared.PropertyConnectionPermissions("custom_value")
```
...
| `PropertyConnectionPermissionsAccountingVendorcreditRead`         | accounting_vendorcredit_read                                      |
| `PropertyConnectionPermissionsAccountingVendorcreditWrite`        | accounting_vendorcredit_write                                     |
...
| `PropertyConnectionPermissionsAccountingBankfeedaccountRead`      | accounting_bankfeedaccount_read                                   |
| `PropertyConnectionPermissionsAccountingBankfeedaccountWrite`     | accounting_bankfeedaccount_write                                  |
| `PropertyConnectionPermissionsAccountingBankfeedtransactionRead`  | accounting_bankfeedtransaction_read                               |
| `PropertyConnectionPermissionsAccountingBankfeedtransactionWrite` | accounting_bankfeedtransaction_write                              |
...
| `PropertyConnectionPermissionsCrmTaxonomyRead`                    | crm_taxonomy_read                                                 |
