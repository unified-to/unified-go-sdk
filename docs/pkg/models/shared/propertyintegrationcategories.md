...
value := shared.PropertyIntegrationCategoriesPassthrough

// Open enum: custom values can be created with a direct type cast
custom := shared.PropertyIntegrationCategories("custom_value")
```
...
| `PropertyIntegrationCategoriesSocial`       | social                                      |