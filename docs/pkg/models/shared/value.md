...
```go
value := shared.CreateValueArrayOfAccountingMetadata5([]shared.AccountingMetadata5{/* values here */})
```
...
switch value.Type {
	...
	case shared.ValueTypeArrayOfAccountingMetadata5:
		// value.ArrayOfAccountingMetadata5 is populated
}
```
