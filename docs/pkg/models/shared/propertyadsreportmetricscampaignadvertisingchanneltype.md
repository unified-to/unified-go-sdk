...
value := shared.PropertyAdsReportMetricsCampaignAdvertisingChannelTypeText

// Open enum: custom values can be created with a direct type cast
custom := shared.PropertyAdsReportMetricsCampaignAdvertisingChannelType("custom_value")
```
