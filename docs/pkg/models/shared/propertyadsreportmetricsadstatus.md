...
value := shared.PropertyAdsReportMetricsAdStatusUnspecified

// Open enum: custom values can be created with a direct type cast
custom := shared.PropertyAdsReportMetricsAdStatus("custom_value")
```
...
| Name                                                   | Value                                                  |
| ------------------------------------------------------ | ------------------------------------------------------ |
| `PropertyAdsReportMetricsAdStatusUnspecified`          | UNSPECIFIED                                            |
