...
```go
atsMetadataValue := shared.CreateAtsMetadataValueArrayOfAtsMetadata5([]shared.AtsMetadata5{/* values here */})
```
...
switch atsMetadataValue.Type {
	...
	case shared.AtsMetadataValueTypeArrayOfAtsMetadata5:
		// atsMetadataValue.ArrayOfAtsMetadata5 is populated
}
```
