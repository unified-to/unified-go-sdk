...
func main() {
    ...
    res, err := s.Project.CreateTaskProject2(ctx, operations.CreateTaskProject2Request{
...
func main() {
    ...
    res, err := s.Project.GetTaskProject2(ctx, operations.GetTaskProject2Request{
        ConnectionID: "<id>",
        ID: "<id>",
    })
    if err != nil {
...
func main() {
    ...
    res, err := s.Project.ListTaskProjects2(ctx, operations.ListTaskProjects2Request{
        ConnectionID: "<id>",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Project.PatchTaskProject2(ctx, operations.PatchTaskProject2Request{
        TaskProject: shared.TaskProject{},
        ConnectionID: "<id>",
        ID: "<id>",
    })
...
func main() {
    ...
    res, err := s.Project.RemoveTaskProject2(ctx, operations.RemoveTaskProject2Request{
        ConnectionID: "<id>",
        ID: "<id>",
    })
    if err != nil {
...
func main() {
    ...
    res, err := s.Project.UpdateTaskProject2(ctx, operations.UpdateTaskProject2Request{
        TaskProject: shared.TaskProject{},
        ConnectionID: "<id>",
        ID: "<id>",
    })
