...
func main() {
    ...
    res, err := s.Subscription.CreatePaymentSubscription2(ctx, operations.CreatePaymentSubscription2Request{
...
func main() {
    ...
    res, err := s.Subscription.GetPaymentSubscription2(ctx, operations.GetPaymentSubscription2Request{
        ConnectionID: "<id>",
        ID: "<id>",
    })
    if err != nil {
...
func main() {
    ...
    res, err := s.Subscription.ListPaymentSubscriptions2(ctx, operations.ListPaymentSubscriptions2Request{
        ConnectionID: "<id>",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Subscription.PatchPaymentSubscription2(ctx, operations.PatchPaymentSubscription2Request{
        PaymentSubscription: shared.PaymentSubscription{},
        ConnectionID: "<id>",
        ID: "<id>",
    })
...
func main() {
    ...
    res, err := s.Subscription.RemovePaymentSubscription2(ctx, operations.RemovePaymentSubscription2Request{
        ConnectionID: "<id>",
        ID: "<id>",
    })
    if err != nil {
...
func main() {
    ...
    res, err := s.Subscription.UpdatePaymentSubscription2(ctx, operations.UpdatePaymentSubscription2Request{
        PaymentSubscription: shared.PaymentSubscription{},
        ConnectionID: "<id>",
        ID: "<id>",
    })
