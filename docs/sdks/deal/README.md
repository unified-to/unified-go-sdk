...
func main() {
    ...
    res, err := s.Deal.CreateCrmDeal(ctx, request)
    if err != nil {
        log.Fatal(err)
    }
    if res.CrmDeal != nil {
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Deal.GetCrmDeal(ctx, request)
    if err != nil {
        log.Fatal(err)
    }
    if res.CrmDeal != nil {
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Deal.ListCrmDeals(ctx, request)
    if err != nil {
        log.Fatal(err)
    }
    if res.CrmDeals != nil {
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Deal.PatchCrmDeal(ctx, request)
    if err != nil {
        log.Fatal(err)
    }
    if res.CrmDeal != nil {
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Deal.RemoveCrmDeal(ctx, request)
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Deal.UpdateCrmDeal(ctx, request)
    if err != nil {
        log.Fatal(err)
    }
    if res.CrmDeal != nil {
