        ...
        FormsForm: shared.FormsForm{
            ...
            Fields: []shared.FormField{
                shared.FormField{
                    ...
                    UpdatedAt: types.MustNewTimeFromString("2025-04-12T04:46:23.830Z"),
                },
                shared.FormField{
                    CreatedAt: types.MustNewTimeFromString("2023-10-05T21:34:29.094Z"),
                    ...
                    Type: shared.FormFieldTypeTextarea,
                    UpdatedAt: types.MustNewTimeFromString("2024-08-23T13:51:14.877Z"),
                },
                shared.FormField{
                    Choices: []string{
                        "vallum",
                    ...
                    UpdatedAt: types.MustNewTimeFromString("2024-02-22T05:07:40.251Z"),
                },
                shared.FormField{
                    CreatedAt: types.MustNewTimeFromString("2023-10-05T21:34:29.094Z"),
                    ...
                    Type: shared.FormFieldTypeTextarea,
                    UpdatedAt: types.MustNewTimeFromString("2024-11-15T08:08:38.111Z"),
                },
            },
            ...
            ID: unifiedgosdk.Pointer("11618bab-d496-4338-8f1e-75eec9205ffa"),
            ...
            UpdatedAt: types.MustNewTimeFromString("2024-08-15T10:54:33.247Z"),
        },
        ConnectionID: "<id>",
    })
    if err != nil {
...
func main() {
    ...
    res, err := s.Form.GetFormsForm(ctx, operations.GetFormsFormRequest{
        ConnectionID: "<id>",
        ID: "<id>",
    })
    if err != nil {
...
func main() {
    ...
    res, err := s.Form.ListFormsForms(ctx, operations.ListFormsFormsRequest{
        ConnectionID: "<id>",
    })
    if err != nil {
        log.Fatal(err)
        ...
        FormsForm: shared.FormsForm{
            ...
            Fields: []shared.FormField{
                shared.FormField{
                    ...
                    Order: unifiedgosdk.Pointer[float64](0.0),
                    Type: shared.FormFieldTypeTextarea,
                    UpdatedAt: types.MustNewTimeFromString("2025-04-12T04:46:23.845Z"),
                },
                shared.FormField{
                    CreatedAt: types.MustNewTimeFromString("2023-10-05T21:34:29.094Z"),
                    ID: unifiedgosdk.Pointer("82b263f9-2d16-4cdf-8e99-d05ba46ce817"),
                    ...
                    Order: unifiedgosdk.Pointer[float64](1.0),
                    Type: shared.FormFieldTypeTextarea,
                    UpdatedAt: types.MustNewTimeFromString("2024-08-23T13:51:14.885Z"),
                },
                shared.FormField{
                    Choices: []string{
                        "vallum",
                    ...
                    Order: unifiedgosdk.Pointer[float64](2.0),
                    Type: shared.FormFieldTypeMultipleSelect,
                    UpdatedAt: types.MustNewTimeFromString("2024-02-22T05:07:40.255Z"),
                },
                shared.FormField{
                    CreatedAt: types.MustNewTimeFromString("2023-10-05T21:34:29.094Z"),
                    Description: unifiedgosdk.Pointer("Sequi antea delectatio."),
                    ...
                    Order: unifiedgosdk.Pointer[float64](3.0),
                    Type: shared.FormFieldTypeTextarea,
                    UpdatedAt: types.MustNewTimeFromString("2024-11-15T08:08:38.121Z"),
                },
            },
            HasMultipleSubmissions: unifiedgosdk.Pointer(false),
            HasProgressBar: unifiedgosdk.Pointer(false),
            HasShuffleQuestions: unifiedgosdk.Pointer(true),
            ID: unifiedgosdk.Pointer("d66b2dac-71cd-4252-af7e-6694b58bc863"),
            IsActive: unifiedgosdk.Pointer(false),
            Name: unifiedgosdk.Pointer("voluptatibus omnis audax Form"),
            PublishedURL: unifiedgosdk.Pointer("https://impartial-institute.org/"),
            ResponseCount: unifiedgosdk.Pointer[float64](423.0),
            UpdatedAt: types.MustNewTimeFromString("2024-08-15T10:54:33.255Z"),
        },
        ConnectionID: "<id>",
        ID: "<id>",
    })
...
func main() {
    ...
    res, err := s.Form.RemoveFormsForm(ctx, operations.RemoveFormsFormRequest{
        ConnectionID: "<id>",
        ID: "<id>",
    })
    if err != nil {
