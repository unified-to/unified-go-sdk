...
func main() {
    ...
    res, err := s.Interview.CreateAtsInterview2(ctx, operations.CreateAtsInterview2Request{
...
func main() {
    ...
    res, err := s.Interview.GetAtsInterview2(ctx, operations.GetAtsInterview2Request{
        ConnectionID: "<id>",
        ID: "<id>",
    })
    if err != nil {
...
func main() {
    ...
    res, err := s.Interview.ListAtsInterviews2(ctx, operations.ListAtsInterviews2Request{
        ConnectionID: "<id>",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Interview.PatchAtsInterview2(ctx, operations.PatchAtsInterview2Request{
        AtsInterview: shared.AtsInterview{},
        ConnectionID: "<id>",
        ID: "<id>",
    })
...
func main() {
    ...
    res, err := s.Interview.RemoveAtsInterview2(ctx, operations.RemoveAtsInterview2Request{
        ConnectionID: "<id>",
        ID: "<id>",
    })
    if err != nil {
...
func main() {
    ...
    res, err := s.Interview.UpdateAtsInterview2(ctx, operations.UpdateAtsInterview2Request{
        AtsInterview: shared.AtsInterview{},
        ConnectionID: "<id>",
        ID: "<id>",
    })
