...
<!-- UsageSnippet language="go" operationID="getUnifiedIntegrationSaml" method="get" path="/unified/integration/saml/{workspace_id}/{integration_type}" -->
```go
package main
...
func main() {
    ...
    res, err := s.Login.GetUnifiedIntegrationSaml(ctx, operations.GetUnifiedIntegrationSamlRequest{
        IntegrationType: "<value>",
        WorkspaceID: "<id>",
    })
    if err != nil {
...
| -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- |
| `ctx`                                                                                                          | [context.Context](https://pkg.go.dev/context#Context)                                                          | :heavy_check_mark:                                                                                             | The context to use for the request.                                                                            |
| `request`                                                                                                      | [operations.GetUnifiedIntegrationSamlRequest](../../pkg/models/operations/getunifiedintegrationsamlrequest.md) | :heavy_check_mark:                                                                                             | The request object to use for the request.                                                                     |
| `opts`                                                                                                         | [][operations.Option](../../pkg/models/operations/option.md)                                                   | :heavy_minus_sign:                                                                                             | The options for this request.                                                                                  |

### Response

**[*operations.GetUnifiedIntegrationSamlResponse](../../pkg/models/operations/getunifiedintegrationsamlresponse.md), error**
