...
func main() {
    ...
    res, err := s.Refund.GetPaymentRefund2(ctx, operations.GetPaymentRefund2Request{
        ConnectionID: "<id>",
        ID: "<id>",
    })
    if err != nil {
...
func main() {
    ...
    res, err := s.Refund.ListPaymentRefunds2(ctx, operations.ListPaymentRefunds2Request{
        ConnectionID: "<id>",
    })
    if err != nil {
        log.Fatal(err)
