...
func main() {
    ...
    res, err := s.Label.CreateShippingLabel2(ctx, operations.CreateShippingLabel2Request{
...
func main() {
    ...
    res, err := s.Label.GetShippingLabel2(ctx, operations.GetShippingLabel2Request{
        ConnectionID: "<id>",
        ID: "<id>",
    })
    if err != nil {
...
func main() {
    ...
    res, err := s.Label.ListShippingLabels2(ctx, operations.ListShippingLabels2Request{
        ConnectionID: "<id>",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Label.PatchShippingLabel2(ctx, operations.PatchShippingLabel2Request{
        ShippingLabel: shared.ShippingLabel{},
        ConnectionID: "<id>",
        ID: "<id>",
    })
...
func main() {
    ...
    res, err := s.Label.RemoveShippingLabel2(ctx, operations.RemoveShippingLabel2Request{
        ConnectionID: "<id>",
        ID: "<id>",
    })
    if err != nil {
...
func main() {
    ...
    res, err := s.Label.UpdateShippingLabel2(ctx, operations.UpdateShippingLabel2Request{
        ShippingLabel: shared.ShippingLabel{},
        ConnectionID: "<id>",
        ID: "<id>",
    })
