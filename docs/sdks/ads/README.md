...
func main() {
    ...
    res, err := s.Ads.CreateAdsCampaign(ctx, operations.CreateAdsCampaignRequest{
        AdsCampaign: shared.AdsCampaign{
            ...
            EndAt: types.MustNewTimeFromString("2025-05-09T23:38:37.453Z"),
            ID: unifiedgosdk.Pointer("5380a70b-289c-4c17-b6c8-c4e2c49d3acf"),
            Labels: []string{
                "comedo",
            },
            Name: unifiedgosdk.Pointer("Emard Inc"),
            StartAt: types.MustNewTimeFromString("2022-07-20T05:42:08.698Z"),
            ...
            UpdatedAt: types.MustNewTimeFromString("2025-12-06T07:53:49.746Z"),
        },
        ConnectionID: "<id>",
    })
    if err != nil {
...
func main() {
    ...
    res, err := s.Ads.CreateAdsGroup(ctx, operations.CreateAdsGroupRequest{
        AdsGroup: shared.AdsGroup{
            ...
            EndAt: types.MustNewTimeFromString("2026-05-25T10:39:26.704Z"),
            ID: unifiedgosdk.Pointer("0c9310b7-2605-42bc-b656-3d318f4422b3"),
            LanguageLocale: unifiedgosdk.Pointer("fr-FR"),
            Name: unifiedgosdk.Pointer("Stark - Baumbach"),
            StartAt: types.MustNewTimeFromString("2025-12-11T17:05:44.743Z"),
            Status: shared.AdsGroupStatusProcessing.ToPointer(),
            Targeting: &shared.PropertyAdsGroupTargeting{},
            UpdatedAt: types.MustNewTimeFromString("2022-01-03T00:12:01.295Z"),
        },
        ConnectionID: "<id>",
    })
    if err != nil {
...
func main() {
    ...
    res, err := s.Ads.PatchAdsCampaign(ctx, operations.PatchAdsCampaignRequest{
        AdsCampaign: shared.AdsCampaign{
            ...
            Currency: unifiedgosdk.Pointer("USD"),
            EffectiveStatus: shared.EffectiveStatusNotEligible.ToPointer(),
            EndAt: types.MustNewTimeFromString("2025-05-09T23:38:37.556Z"),
            ID: unifiedgosdk.Pointer("038e684a-079e-4d4f-8b11-c04f15ea2565"),
            Labels: []string{
                "comedo",
            },
            Name: unifiedgosdk.Pointer("Emard Inc"),
            StartAt: types.MustNewTimeFromString("2022-07-20T05:42:08.703Z"),
            Status: shared.AdsCampaignStatusProcessingFailed.ToPointer(),
            Targeting: &shared.PropertyAdsCampaignTargeting{},
            TotalSpendAmount: unifiedgosdk.Pointer[float64](2349.8642875347286),
            UpdatedAt: types.MustNewTimeFromString("2025-12-06T07:53:49.869Z"),
        },
        ConnectionID: "<id>",
        ID: "<id>",
    })
...
func main() {
    ...
    res, err := s.Ads.PatchAdsGroup(ctx, operations.PatchAdsGroupRequest{
        AdsGroup: shared.AdsGroup{
            ...
            Currency: unifiedgosdk.Pointer("USD"),
            EffectiveStatus: shared.AdsGroupEffectiveStatusPaused.ToPointer(),
            EndAt: types.MustNewTimeFromString("2026-05-25T10:39:26.858Z"),
            ID: unifiedgosdk.Pointer("62e0b7b4-3a8f-4a3b-9e59-2cfcfc725a00"),
            LanguageLocale: unifiedgosdk.Pointer("fr-FR"),
            Name: unifiedgosdk.Pointer("Stark - Baumbach"),
            StartAt: types.MustNewTimeFromString("2025-12-11T17:05:44.886Z"),
            Status: shared.AdsGroupStatusProcessing.ToPointer(),
            Targeting: &shared.PropertyAdsGroupTargeting{},
            UpdatedAt: types.MustNewTimeFromString("2022-01-03T00:12:01.348Z"),
        },
        ConnectionID: "<id>",
        ID: "<id>",
    })
