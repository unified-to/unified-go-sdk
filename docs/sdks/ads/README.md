...
<!-- UsageSnippet language="go" operationID="listAdsPromotedes" method="get" path="/ads/{connection_id}/promoted" -->
```go
package main
...
func main() {
    ...
    res, err := s.Ads.ListAdsPromotedes(ctx, operations.ListAdsPromotedesRequest{
        ConnectionID: "<id>",
    })
    if err != nil {
        log.Fatal(err)
    }
    if res.AdsPromotedes != nil {
        // handle response
    }
}
```
...
| ---------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- |
| `ctx`                                                                                          | [context.Context](https://pkg.go.dev/context#Context)                                          | :heavy_check_mark:                                                                             | The context to use for the request.                                                            |
| `request`                                                                                      | [operations.ListAdsPromotedesRequest](../../pkg/models/operations/listadspromotedesrequest.md) | :heavy_check_mark:                                                                             | The request object to use for the request.                                                     |
| `opts`                                                                                         | [][operations.Option](../../pkg/models/operations/option.md)                                   | :heavy_minus_sign:                                                                             | The options for this request.                                                                  |

### Response

**[*operations.ListAdsPromotedesResponse](../../pkg/models/operations/listadspromotedesresponse.md), error**
