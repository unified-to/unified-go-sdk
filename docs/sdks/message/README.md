...
func main() {
    ...
    res, err := s.Message.CreateMessagingMessage2(ctx, operations.CreateMessagingMessage2Request{
...
func main() {
    ...
    res, err := s.Message.GetMessagingMessage2(ctx, operations.GetMessagingMessage2Request{
        ConnectionID: "<id>",
        ID: "<id>",
    })
    if err != nil {
...
func main() {
    ...
    res, err := s.Message.ListMessagingMessages2(ctx, operations.ListMessagingMessages2Request{
        ConnectionID: "<id>",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Message.PatchMessagingMessage2(ctx, operations.PatchMessagingMessage2Request{
        MessagingMessage: shared.MessagingMessage{},
        ConnectionID: "<id>",
        ID: "<id>",
    })
...
func main() {
    ...
    res, err := s.Message.RemoveMessagingMessage2(ctx, operations.RemoveMessagingMessage2Request{
        ConnectionID: "<id>",
        ID: "<id>",
    })
    if err != nil {
...
func main() {
    ...
    res, err := s.Message.UpdateMessagingMessage2(ctx, operations.UpdateMessagingMessage2Request{
        MessagingMessage: shared.MessagingMessage{},
        ConnectionID: "<id>",
        ID: "<id>",
    })
