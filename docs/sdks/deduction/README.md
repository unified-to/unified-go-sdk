...
func main() {
    ...
    res, err := s.Deduction.CreateHrisDeduction2(ctx, operations.CreateHrisDeduction2Request{
...
func main() {
    ...
    res, err := s.Deduction.GetHrisDeduction2(ctx, operations.GetHrisDeduction2Request{
        ConnectionID: "<id>",
        ID: "<id>",
    })
    if err != nil {
...
func main() {
    ...
    res, err := s.Deduction.ListHrisDeductions2(ctx, operations.ListHrisDeductions2Request{
        ConnectionID: "<id>",
    })
    if err != nil {
        log.Fatal(err)
...
func main() {
    ...
    res, err := s.Deduction.PatchHrisDeduction2(ctx, operations.PatchHrisDeduction2Request{
        HrisDeduction: shared.HrisDeduction{},
        ConnectionID: "<id>",
        ID: "<id>",
    })
...
func main() {
    ...
    res, err := s.Deduction.RemoveHrisDeduction2(ctx, operations.RemoveHrisDeduction2Request{
        ConnectionID: "<id>",
        ID: "<id>",
    })
    if err != nil {
...
func main() {
    ...
    res, err := s.Deduction.UpdateHrisDeduction2(ctx, operations.UpdateHrisDeduction2Request{
        HrisDeduction: shared.HrisDeduction{},
        ConnectionID: "<id>",
        ID: "<id>",
    })
