...
func main() {
    ...
    res, err := s.Event.CreateCrmEvent(ctx, request)
    if err != nil {
        log.Fatal(err)
    }
    if res.CrmEvent != nil {
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Event.GetCrmEvent(ctx, request)
    if err != nil {
        log.Fatal(err)
    }
    if res.CrmEvent != nil {
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Event.ListCrmEvents(ctx, request)
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Event.PatchCrmEvent(ctx, request)
    if err != nil {
        log.Fatal(err)
    }
    if res.CrmEvent != nil {
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Event.RemoveCrmEvent(ctx, request)
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {
...
func main() {
    ...
    ctx := context.Background()
    res, err := s.Event.UpdateCrmEvent(ctx, request)
    if err != nil {
        log.Fatal(err)
    }
    if res.CrmEvent != nil {
