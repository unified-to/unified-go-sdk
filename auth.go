...
func newAuth(rootSDK *UnifiedTo, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Auth {
	return &Auth{
		rootSDK:          rootSDK,
...
func (s *Auth) GetUnifiedIntegrationSaml(ctx context.Context, request operations.GetUnifiedIntegrationSamlRequest, opts ...operations.Option) (*operations.GetUnifiedIntegrationSamlResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
