...
func (s *Accounting) CreateAccountingItem(ctx context.Context, request operations.CreateAccountingItemRequest) (*operations.CreateAccountingItemResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
...
func (s *Accounting) GetAccountingItem(ctx context.Context, request operations.GetAccountingItemRequest) (*operations.GetAccountingItemResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
...
func (s *Accounting) ListAccountingItems(ctx context.Context, request operations.ListAccountingItemsRequest) (*operations.ListAccountingItemsResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	url, err := utils.GenerateURL(ctx, baseURL, "/accounting/{connection_id}/item", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
...
func (s *Accounting) PatchAccountingItem(ctx context.Context, request operations.PatchAccountingItemRequest) (*operations.PatchAccountingItemResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	url, err := utils.GenerateURL(ctx, baseURL, "/accounting/{connection_id}/item/{id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
...
func (s *Accounting) RemoveAccountingItem(ctx context.Context, request operations.RemoveAccountingItemRequest) (*operations.RemoveAccountingItemResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	url, err := utils.GenerateURL(ctx, baseURL, "/accounting/{connection_id}/item/{id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
...
func (s *Accounting) UpdateAccountingItem(ctx context.Context, request operations.UpdateAccountingItemRequest) (*operations.UpdateAccountingItemResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	url, err := utils.GenerateURL(ctx, baseURL, "/accounting/{connection_id}/item/{id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
