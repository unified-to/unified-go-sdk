...
func (s *Storage) CreateStorageFile(ctx context.Context, request operations.CreateStorageFileRequest, security operations.CreateStorageFileSecurity) (*operations.CreateStorageFileResponse, error) {
...
func (s *Storage) GetStorageFile(ctx context.Context, request operations.GetStorageFileRequest, security operations.GetStorageFileSecurity) (*operations.GetStorageFileResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Storage) ListStorageFiles(ctx context.Context, request operations.ListStorageFilesRequest, security operations.ListStorageFilesSecurity) (*operations.ListStorageFilesResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Storage) PatchStorageFile(ctx context.Context, request operations.PatchStorageFileRequest, security operations.PatchStorageFileSecurity) (*operations.PatchStorageFileResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Storage) RemoveStorageFile(ctx context.Context, request operations.RemoveStorageFileRequest, security operations.RemoveStorageFileSecurity) (*operations.RemoveStorageFileResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Storage) UpdateStorageFile(ctx context.Context, request operations.UpdateStorageFileRequest, security operations.UpdateStorageFileSecurity) (*operations.UpdateStorageFileResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
